      ...
      <div className="px-6 mb-6">
        <div className="flex items-center justify-between mb-3">
          ...
          <button onClick={regeneratePlan} disabled={regenerating} className="text-primary text-sm font-bold flex items-center gap-1" data-testid="regen-plan-btn">
            ...
            {regenerating ? 'Generazione...' : plan ? 'Rigenera' : 'Genera piano'}
          </button>
        </div>
        {todayPlan ? (
          ...
          <div className="bg-surface border border-border rounded-3xl p-5 text-center">
            <p className="text-text-secondary mb-2">Nessun allenamento pianificato per oggi.</p>
            <p className="text-text-secondary text-sm">Usa "Genera piano" in alto per creare il tuo programma settimanale.</p>
          </div>
        )}
      </div>
